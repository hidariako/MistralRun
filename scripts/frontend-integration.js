 ...
 * This file demonstrates how to integrate Mistralrun with a web frontend
 */

// For React/Vue/Angular applications
export class MistralrunClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new MistralrunClient(provider, contractAddress);
